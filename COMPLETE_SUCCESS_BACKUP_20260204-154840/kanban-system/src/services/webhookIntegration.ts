...
class WebhookIntegrationService {
  ...
  constructor(baseUrl?: string) {
    // Use current origin in development (Vite proxy) or explicit baseUrl in production
  ...
  connect(): Promise<void> {
    return new Promise((resolve, reject) => {
      try {
        // For Socket.io, we need to connect to the backend directly, not through Vite proxy
