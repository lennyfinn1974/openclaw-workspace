...
const COMMODITIES: Record<string, CommodityConfig> = {
  ...
  'HG=F':  { symbol: 'HG=F', displayName: 'Copper', basePrice: 5.91, dailyVolatility: 0.020, avgDailyVolume: 50000, spreadBps: 5, contractMultiplier: 25000, tradingHours: 'us_futures' },
